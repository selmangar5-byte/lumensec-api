...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<event_stream_parser>.freeze, ["~> 1.0"])
    s.add_dependency(%q<faraday>.freeze, ["~> 2.13", ">= 2.13.2"])
    s.add_dependency(%q<faraday-typhoeus>.freeze, ["~> 1.1"])
    s.add_dependency(%q<googleauth>.freeze, ["~> 1.8"])
    s.add_dependency(%q<typhoeus>.freeze, ["~> 1.4", ">= 1.4.1"])
  end
end
