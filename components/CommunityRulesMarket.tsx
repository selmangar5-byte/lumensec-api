      ...
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">{t.communityRules}</h3>
              <p className="text-[10px] text-slate-500 font-mono">{installedCount}/{rules.length} {t.rulesInstalled}</p>
            </div>
          </div>
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className={`text-[9px] font-mono uppercase px-2 py-1 rounded border ${getSeverityColor(rule.severity)}`}>
                {t[rule.severity.toLowerCase() as keyof typeof t]}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="text-[10px] text-slate-500 font-mono">
                  {rule.installs.toLocaleString()} {t.installs}
                </div>
              </div>
